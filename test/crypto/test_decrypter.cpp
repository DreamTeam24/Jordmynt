...
BOOST_AUTO_TEST_CASE(Decrypter_decrypt)
{
    //-----------------------------------------//
    ...
    // Compute output
    jm::crypto::Decrypter decrypter{ key, initializationVector };
    ...
    jm::crypto::Bytes plaintext1{ decrypter.decrypt(ciphertext1, additionalAuthenticatedData1, authenticationTag1) };
    ...
    jm::crypto::Bytes plaintext2{ decrypter.decrypt(ciphertext2, additionalAuthenticatedData2, authenticationTag2) };
