...
BOOST_AUTO_TEST_CASE(Encrypter_encrypt)
{
    //-----------------------------------------//
    ...
    // Compute output
    jm::crypto::Encrypter encrypter{ key, initializationVector };
    jm::crypto::Bytes authenticationTag1{};
    jm::crypto::Bytes ciphertext1{ encrypter.encrypt(plaintext1, additionalAuthenticatedData1, authenticationTag1) };
    ...
    jm::crypto::Bytes ciphertext2{ encrypter.encrypt(plaintext2, additionalAuthenticatedData2, authenticationTag2) };
